...
const Router = (props) => Boolean(DOCZ_HASH_ROUTER) ? (React.createElement(reactRouterDom.HashRouter, Object.assign({}, props))) : (React.createElement(reactRouterDom.BrowserRouter, Object.assign({}, props)));
        ...
        const Theme = props => {
            ...
            return (React.createElement(ErrorBoundary, null,
                React.createElement(state.Provider, { initial: Object.assign({}, db, { themeConfig, transform }) },
                    React.createElement(DataServer, { websocketUrl: DOCZ_WEBSOCKET_URL },
                        React.createElement(Router, { basename: DOCZ_BASE_URL },
...
const BasePlayground = ({ components, className, style, wrapper: Wrapper, children, __scope, __position, __code, __codesandbox, }) => {
    ...
    return (React.createElement(components.render, Object.assign({}, props, { component: Wrapper ? React.createElement(Wrapper, null, children) : children, scope: __scope, position: __position, code: __code, codesandbox: __codesandbox })));
};
