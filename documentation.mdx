...
menu: Click to see documentation
---
...
<Playground>
    <Grid style={{backgroundColor: 'AliceBlue'}} fullWidth gutters={10}>
        <Row reverse align="left">
            <Col mobile={10} mobileOffset={2} phablet={6} tablet={4} tabletOffset={8} desktop={4} wideDesktop={3} style={{backgroundColor: 'red'}}>
            <div>block 1</div>
            </Col>
            <Col width={6} phablet={6} tablet={8} desktop={4} wideDesktop={6} style={{backgroundColor: 'blue'}}>
            <div>block 2</div>
            </Col>
            <Col width={6} phablet={12} tablet={4} desktop={4} wideDesktop={3} style={{backgroundColor: 'green'}}>
            <div>block 3</div>
            </Col>
        </Row>
    </Grid>
